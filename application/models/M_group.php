...
class M_group extends CI_Model {
    ...
    var $table = 'transaksi';
    var $column_order = array('TGL_DATA_MASUK','ND','FASE_TRANSAKSI','ESKALASI_KENDALA','KETERANGAN_TAMBAHAN',null); //set column field database for datatable orderable
    ...
    public function get_info_by_ND($ND) {
